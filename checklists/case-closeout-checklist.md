...
Use this checklist before closing an investigation, publishing a report, or handing off final notes.



The goal is simple: close the case cleanly, protect evidence, and make sure the next person can understand what happened without guessing.
...
Confirm known facts are clearly listed.
...
Confirm assumptions are not written as facts.
...
Confirm evidence is handled safely.
...
Confirm indicators are documented safely.
...
For public or portfolio use, sanitize sensitive indicators first.
...
Confirm approval-required actions are clearly marked.
...
Confirm the correct report type was prepared.
...
> Based on the available evidence, the activity was reviewed and no confirmed compromise was identified. Remaining uncertainty and follow-up items are documented above. Any operational response actions require approval through the proper process.
