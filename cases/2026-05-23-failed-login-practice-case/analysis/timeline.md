...
This timeline documents the order of events for the failed login practice case.
...
| TBD | Failed login activity identified | Practice SIEM / Windows Security Logs | Authentication activity was selected for investigation practice. |

| TBD | Case created | Blue Team Command Center | Practice case folder created from reusable case template. |

| TBD | Initial case summary documented | CASE.md | Known facts, assumptions, missing information, and next steps were documented. |

| TBD | Timeline started | analysis/timeline.md | Timeline is being built to organize investigation flow. |

| TBD | Indicators pending review | analysis/indicators.md | Source, account, host, and event details still need to be documented. |

| TBD | Findings pending review | analysis/findings.md | Final finding cannot be completed until indicators and evidence are reviewed. |
