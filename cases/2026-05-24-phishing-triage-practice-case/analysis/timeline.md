...
This timeline documents the order of events for the phishing triage practice case.
...
| TBD | Suspicious email identified | Practice Email Alert / User Report | Email selected for phishing triage practice. |
...
| TBD | Sender review pending | analysis/indicators.md | Sender, reply-to, and authentication results still need review. |

| TBD | URL/attachment review pending | analysis/indicators.md | Embedded links and attachments need safe review if applicable. |

| TBD | User interaction pending | CASE.md | User click, credential entry, or attachment open status still unknown. |

| TBD | Findings pending review | analysis/findings.md | Final finding cannot be completed until indicators and interaction details are reviewed. |
